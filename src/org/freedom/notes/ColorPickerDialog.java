...
public class ColorPickerDialog extends Dialog {
	...
	private static class ColorPickerView extends View {
		...
		ColorPickerView(final Context c, final OnColorChangedListener l,
				final int color) {
			super(c);
			mListener = l;
		...
		private int rotateColor(final int color, final float rad) {
	...
	public ColorPickerDialog(final Context context,
			final OnColorChangedListener listener, final int initialColor) {
		super(context);
